...
import baustro.fin.ec.ui.panels.CasoPanel;
...
public class MainFrame extends JFrame {
    ...
    private static final String PANEL_CASO         = "casos";
    ...
    private JPanel buildSidebar() {
        ...
        sidebar.add(navButton("Soporte",      IconManager.ICON_CASO,       PANEL_CASO));
