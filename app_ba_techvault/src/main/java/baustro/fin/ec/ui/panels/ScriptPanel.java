...
public class ScriptPanel extends JPanel {
    ...
    private void loadFiles() {
        ...
        if (!dir.exists()) {
            JOptionPane.showMessageDialog(this,
                    "La carpeta de scripts no existe:\n" + dir.getAbsolutePath());
            return;
        }
    ...
    private void openSelected() {
        ...
        if (row < 0) { JOptionPane.showMessageDialog(this, "Seleccione un script."); return; }
    ...
    class IndexRenderer extends DefaultTableCellRenderer {
        public Component getTableCellRendererComponent(JTable t, Object v,
            ...
            lbl.setForeground(sel ? UIConstants.TEXT_BRIGHT : UIConstants.TEXT_3);
    ...
    class SizeRenderer extends DefaultTableCellRenderer {
        public Component getTableCellRendererComponent(JTable t, Object v,
            ...
            lbl.setText(v != null ? v.toString() : "");
            lbl.setFont(FONT_SMALL);
            lbl.setForeground(sel ? UIConstants.TEXT_BRIGHT : UIConstants.TEXT_2);
