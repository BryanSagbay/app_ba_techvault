...
public final class UIConstants {
    ...
    public static Color getEstadoColor(String estado) {
        ...
        return switch (estado) {
            case "Abierto"      -> ACCENT_ORANGE;
            case "En Progreso"  -> ACCENT_BLUE;
            case "Resuelto"     -> ACCENT_GREEN;
            case "Cerrado"      -> TEXT_MUTED;
            case "Pendiente"    -> ACCENT_ORANGE;
            case "Completada"   -> ACCENT_GREEN;
            case "Cancelada"    -> ACCENT_RED;
            case "Activo"       -> ACCENT_GREEN;
            case "Inactivo"     -> ACCENT_RED;
            case "Mantenimiento"-> ACCENT_ORANGE;
            default             -> TEXT_SECONDARY;
        };
    }
}
