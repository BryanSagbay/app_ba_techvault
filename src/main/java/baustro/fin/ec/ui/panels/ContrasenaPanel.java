...
public class ContrasenaPanel extends JPanel {
    ...
    private void buildUI() {
        ...
        // Categorias comunes para contraseñas
        ...
        hsf = new HeaderSearchFilter(
                ...
                new HeaderSearchFilter.ComboConfig("Ordenar", new String[]{"Titulo A-Z","Categoria","Reciente"}, "Titulo A-Z")
    ...
    private void openForm(Contrasena existing){
        ...
        row2(form,gbc,r++,"URL / Sistema",fUrl);row2(form,gbc,r++,"Categoria",fCat);
